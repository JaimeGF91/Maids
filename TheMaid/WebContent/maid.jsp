...
">
            ...
            <div class="collapsibles">
                 <h1 style="    color: #007bff;    font-weight: 800;">THE MAID</h1>
                <h2 class="collapsed">
                
                
                 <%                
            modelo_maid usuario_Seelect = (modelo_maid)sesion.getAttribute("okanunok"); 	            
              if(usuario_Seelect!=null  ){
			%>
   <%=usuario_Seelect.getNombre()%>
...
<div class="row">
  ...
  <div class="col-8">
    ...
    height: 100%;
    object-fit: cover;
    max-height: 500px;" src=<%				
				modelo_foto modfot = gesu.Obtener_foto_porID_unica(usuario_Seelect.getId());
  ...
  <div class="col-4">
  <div style="   FONT-SIZE: 35PX;    font-weight: lighter;    color: #0052ab;">Descripcion: </div>
 <p style="    FONT-SIZE: 20PX;"><%=usuario_Seelect.getDescripcion()%></p>
  
  <div style="   FONT-SIZE: 35PX;    font-weight: lighter;    color: #0052ab;">
  
  Contacto:  <p style="    FONT-SIZE: 20PX;"><%=usuario_Seelect.getCorreo()%></p>  
  Honorarios <p style="    FONT-SIZE: 20PX;"><%=usuario_Seelect.getHonorarios()%></p>
